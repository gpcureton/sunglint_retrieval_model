...
PRO thirdGlintMomentFunction21,GEOM,kappa_xi,M21_L,pderiv
	...
	lambda_xi_Det = 1.D - lambda_xi_11^2.D
	;PRINT,'tGMF21(): kappa_xi_2',kappa_xi_2
	;PRINT,'tGMF21(): kappa_xi_11',kappa_xi_11
	;PRINT,'tGMF21(in): kappa_xi',kappa_xi
	;PRINT,'tGMF21(): lambda_xi_11',lambda_xi_11
	;PRINT,'tGMF21(): lambda_xi_Det',lambda_xi_Det
	...
	M21_L_dkappa_xi_21 = DBLARR(GEOM.N_angles)
	M21_L_dkappa_xi_12 = DBLARR(GEOM.N_angles)

	;PRINT,"thirdGlintMomentFunction21(): M2_L_sim[geom] = ",mu_L_11
	...
	FOR geometry = 0L,N_ELEMENTS(GEOM.xi_min)-1L DO BEGIN
		...
		linPart = mu_L_11[geometry] ;;; This is actually M2_L[geometry]
		...
		;;; Calculate the derivatives w.r.t. kappa_xi_21 and kappa_xi_12

		M21_L_dkappa_xi_21[geometry]= (1.D/mu_L_1[geometry])*INT_2D('prob2D_21_xi_diff_21_int',AB_Limits,'PQ_Limits',6,/DOUBLE)
		M21_L_dkappa_xi_12[geometry]= (1.D/mu_L_1[geometry])*INT_2D('prob2D_21_xi_diff_12_int',AB_Limits,'PQ_Limits',6,/DOUBLE)
	ENDFOR

	pderiv = [[replicate(1.0, GEOM.N_angles)],[M21_L_dkappa_xi_21],[M21_L_dkappa_xi_12]]

	;PRINT,"tGMF21(out): M21_L[geom] = ",M21_L
	;print,""
END

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

PRO thirdGlintMomentFunction12,GEOM,kappa_xi,M12_L,pderiv

	;;; GEOM: Structure containing angular dependent parameters
	;;;		for a range of geometries.
	;;; kappa_xi: Vector containing the slope cumulant functions,
	;;;		kappa_xi_11, kappa_xi_21 and kappa_xi_12 for a single lag value.
	;;; M12_L: Vector containing the third glint moment function for each 
	;;;		geometry in GEOM, along the tau_1=tau2 axis, for a single lag value
	...
	M12_L_dkappa_xi_21 = DBLARR(GEOM.N_angles)
	M12_L_dkappa_xi_12 = DBLARR(GEOM.N_angles)

	;PRINT,"thirdGlintMomentFunction12(): M2_L_sim[geom] = ",mu_L_11

	;;; Calculate the glint moment function M12_L for each geometry
	...
	FOR geometry = 0L,N_ELEMENTS(GEOM.xi_min)-1L DO BEGIN
		...
		M12_L_dkappa_xi_21[geometry]= (1.D/mu_L_1[geometry])*INT_2D('prob2D_12_xi_diff_21_int',AB_Limits,'PQ_Limits',6,/DOUBLE)
		M12_L_dkappa_xi_12[geometry]= (1.D/mu_L_1[geometry])*INT_2D('prob2D_12_xi_diff_12_int',AB_Limits,'PQ_Limits',6,/DOUBLE)
	ENDFOR

	pderiv = [[replicate(1.0, GEOM.N_angles)],[M12_L_dkappa_xi_21],[M12_L_dkappa_xi_12]]
END
...
PRO thirdGlintMomentFunction2,GEOM,kappa_xi,M3_L,pderiv
	...
	M3_L_dkappa_xi_111 = DBLARR(GEOM.N_angles)
	...
	FOR geometry = 0L,N_ELEMENTS(GEOM.xi_min)-1L DO BEGIN
		...
		;;; Calculate the derivatives w.r.t. kappa_xi_111

		M3_L_dkappa_xi_111[geometry] = $
			(1.D/mu_L_1[geometry]) * INT_3D('prob3D_xi_diff_111_int',AB_Limits,'PQ_Limits','UV_Limits',6,/DOUBLE)
	ENDFOR

	pderiv = [M3_L_dkappa_xi_111]
